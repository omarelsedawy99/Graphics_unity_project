...
public class comp : MonoBehaviour
{
    ...
    public GameObject dainasour;
    Vector3 dainasourPosition;
    int Xrnd;
    System.Random rnd;
    //*************************************************************************************************************************************************
    //Get components
    void Start()
	{
        ...
        body.velocity= new Vector3(0f, 0f, 8f);
        body.AddForce(5f, 5f, 5f, ForceMode.Impulse);
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("zom"))
        {
            ...
            //transform.Translate(4.4f * Time.deltaTime, 0f, 0f);
    ...
    void FixedUpdate()
	{
        ...
        dainasourPosition = dainasour.transform.position;
        if (playerPosition.x -9> dainasourPosition.x)
        {
            dainasour.transform.Translate(5f * Time.deltaTime, 0f, 0f);
        }
        if (dainasourPosition.x - 9 > playerPosition.x)
        {
            dainasour.transform.Translate(-5f * Time.deltaTime, 0f, 0f);
        }
        ...
        {
                        atck = false;
            transform.Translate(0f, 0f, 7.8f * Time.deltaTime);
            if (killed)
            {
